...
public class EventFaith {
	...
	public void eventPrint(Scanner scan) {
		...
		System.out.println("  나와 홀짝 내기를 하지 않겠나?");
		System.out.println("  나에게서 이기면 무궁한 영광을 너에게 주지.");
		System.out.println();
		System.out.println(" =================================================");
		System.out.println();
	...
	public int answerCase(String answer) {	
		...
		if (answer.equals("n")) {
			...
			System.out.println();
			System.out.println(" =================================================");
			System.out.println("  [신앙이 +20 증가했습니다.]");
			System.out.println();
			try {
				Thread.sleep(3500); // 5초 후
			} catch (Exception e) {
		...
		if (answer.equals("y")) {
			...
			System.out.println(" ====[" + getEventCharacter() + "]========================================");
			System.out.println();
			System.out.println("  자, 내 손에는 1에서 10 사이의 숫자 하나가 들어있다.");
			System.out.println("  홀인지 짝인지 맞춰보거라.");
			System.out.println();
			System.out.println(" =================================================");
		...
		while(true) {
			...
			if(random % 2 == 0) {
				if(user == 2) {
					...
					System.out.println("  (악마가 펼친 손 안에는 ["+random+"]이/가 있었습니다.)");
					System.out.println();
					System.out.println(" =================================================");
					System.out.println("  (내기를 지켜보던 Google 신이 도박을 한다며 노하셨습니다.)");
					System.out.println("  [신앙이 -10 감소했습니다.]");
					System.out.println();
					try {
						Thread.sleep(3500); // 5초 후
					} catch (Exception e) {
					...
					System.out.println();
					System.out.println(" =================================================");
					System.out.println("  [신앙이 -20 감소했습니다.]");
					System.out.println();
					try {
						Thread.sleep(3500); // 5초 후
					} catch (Exception e) {
